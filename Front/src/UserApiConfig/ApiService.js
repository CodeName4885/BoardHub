...
export function modifynickname(nicknameVal){
  ...
  return Call("/modifynickname", "post", nicknameVal).then(response =>{
    console.log(response);
...
export function modifyphone(phoneVal){
  ...
  return Call("/modifyphone", "post", phoneVal).then(response =>{
    console.log(response)
    window.location.reload();
  }).catch((error)=>{
    console.log("error = ", error);
...
export function drawUser(){
  ...
  return Call("/drawuser", "post", null).then((response) => {
    console.log(response);
    logout();
  }).catch((error)=>{
    console.log("error = ", error);
...
export function usernameChk(usernameVal){
  ...
  return Call("/usernamechk", "post", usernameVal).then((response) => {
    console.log(response);
    if(response){
...
export function emailChk(inputChangeEmail){
  ...
  return Call("/emailchk", "post", inputChangeEmail).then((response =>{
    console.log(response);
    return response;
  })).catch((error)=>{
    Swal.fire({
...
export function getUsername(){
  return Call("/getusername", "POST", null).then((response) => {
...
export function pwdChangeAPI(password){
  ...
  return Call("/modifypassword", "post", password).then((response) => {
    console.log(response);
    if(response){
      Swal.fire({
        icon: "success",
