                    ...
                    <section className={mypage["mypage-wrap"]}>
                        <div className={mypage["content-side"]}>
                            <div className={mypage["profile-card"]}>
                                <div className={mypage["profile-card-img"]}>
                                    {socialtoken != null ? (
                                        ...
                                        <img
                                            src={
                                                "../../static/game-warrior/img/profile/" +
                            ...
                            <nav className={mypage["side-nav"]}>
                                <ul className={mypage["side-nav-list"]}>
                                    <li
                                        className={`${mypage["side-nav-item"]} ${mypage["active"]}`}
                                    >
                                        회원 정보
                                    </li>
                        ...
                        <div className={mypage["content-body"]}>
                            <div className={mypage["content-body-wrap"]}>
                                <h3 className={mypage["content-body-title"]}>
                                    회원 정보
                                </h3>
                            </div>
                            <nav className={mypage["content-body-nav"]}>
                                <ul className={mypage["content-body-items"]}>
                                    <li
                                        className={
                                            mypage["content-body-items-item"]
                                        }
                                    >
                                        회원 정보
                                    </li>
                            ...
                            <div
                                className={mypage["content-body-form-section"]}
                            >
                                <h4
                                    className={
                                        mypage[
                                            "content-body-form-section-title"
                                        ]
                                    }
                                >
                                    회원정보 설정
                            ...
                            <table
                                className={
                                    mypage["content-body-form-section-table"]
                                }
                            >
                                <colgroup>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className={mypage["table-d"]}>
                                                {userData && userData.nickname}
                                                <button
                                                    className={`${mypage["table-btn"]} ${mypage["nickname-btn"]}`}
