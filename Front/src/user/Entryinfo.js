                ...
                <div className={joincss["entry-wrap"]}>
                    ...
                    <div className={joincss["email-box"]}>
                        ...
                        <div className={joincss["send-email-box"]}>
                            <button
                                className={`${joincss["send-email-btn"]} ${
                                    inputChangeEmail === "" || !sendBtn
                                        ? join["disabled"]
                                        : ""
                                }`}
                                disabled={inputChangeEmail === "" || !sendBtn}
                                onClick={mailConfirm}
                            >
                                인증메일 발송
                            </button>
                    ...
                    <div className={joincss["email-box"]}>
                        <div
                            className={`${joincss["email-input-box"]} ${
                                isMailConfirm === false
                                    ? joincss["disabled"]
                                    : ""
                            }`}
                        >
                            <input
                                className={`${joincss["mailconfirm-input"]} ${
                                    !isMailConfirm ? joincss["disabled"] : ""
                                }`}
                                disabled={!isMailConfirm}
                                type="text"
                                name="verification"
                                onChange={inputDataChange}
                            />
                            {isMailConfirm ? (
                                <div className={joincss["timer"]}>
                        ...
                        <div className={joincss["send-email-box"]}>
                            <button
                                className={`${joincss["mailconfirm-btn"]} ${
                                    !isMailConfirm ? joincss["disabled"] : ""
                                }`}
                                display={!isMailConfirm}
                                onClick={mailConfirmCheck}
                            >
                                인증번호 확인
                            </button>
                        </div>
                    ...
                    <p className={joincss["label-box"]}>
                        <label>아이디</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span
                            className={`${joincss["usernameCheck"]} ${
                                usernameCheckMsg === "중복된 아이디 입니다."
                                    ? joincss["red"]
                                    : ""
                            }`}
                        >
                    ...
                    <div className={joincss["email-box"]}>
                        <div
                            className={`${joincss["email-input-box"]} ${
                                !isUsernameDisabled ? joincss["disabled"] : ""
                            }`}
                        >
                            <input
                                className={`${joincss["username-input"]} ${
                                    !isUsernameDisabled
                                        ? joincss["disabled"]
                                        : ""
                                }`}
                        ...
                        <div className={joincss["send-email-box"]}>
                            <button
                                className={`${joincss["send-username-btn"]} ${
                                    !isUsernameDisabled ? join["disabled"] : ""
                                }`}
                                disabled={!isUsernameDisabled}
                    ...
                    <div className={joincss["send-btn-box"]}>
                        <a href="/completedjoin">
                            <button
                                className={`${joincss["send-btn"]} ${
                                    !isAllInputFilled ? joincss["disabled"] : ""
                                }`}
