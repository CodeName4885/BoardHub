                ...
                <div className={pwd["content-wrap"]}>
                    ...
                    <article className={pwd["content-article"]}>
                        ...
                        <div className={pwd["content-article-text-box"]}>
                            <span className={pwd["content-article-text"]}>
                                <span style={{ color: "#069FEE" }}>
                                    이메일 인증
                                </span>
                                을 진행해주세요.
                            </span>
                        ...
                        <div className={pwd["email-box"]}>
                            ...
                            >
                                <input
                                    className={`${pwd["mailconfirm-input"]} ${
                                        !isMailConfirm ? pwd["disabled"] : ""
                                    }`}
                    ...
                    <div className={pwd["next-btn-box"]}>
                        <button
                            className={`${pwd["next-btn"]} ${
                                !isConfirmed ? pwd["disabled"] : ""
                            }`}
