...
export function TradeDetailPage() {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:8080/show/tradeDetail/${comm_id}`)
            .then((res) => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:8080/show/reviewDetail/reply/${comm_id}`)
            .then((res) => {
                console.log("Response: ", res);
                    ...
                    {comments.map((comment, index) => (
                        <div key={index} className="comment">
                            <div className="comment-info">
                                ...
                                <span className="reply-reg-date">
                                    {getTimeAgo(comment.regdate)}
                                </span>
                                <button
                                    type="button"
